...
var Triangle = /** @class */ (function () {
    ...
    Triangle.prototype.draw = function (height) {
        if (height === void 0) { height = 100; }
        var factor = Object.values(this.sides).sort(function (a, b) { return b - a; })[0] / (height * 0.9);
        var A = [0, height];
        //A to C
        var C = [this.sides.b / factor, A[1]];
        //C to B        
